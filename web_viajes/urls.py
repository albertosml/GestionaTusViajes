...
urlpatterns = [
    ...
    path('ciudad/<int:pk>/deletefoto/', forms.FotoDeleteCiudad.as_view(), name='ciudad_foto_delete'),
    ...
    path('comprobar/', views.comprobar_usuarios_viaje, name="comprobar_usuarios_viaje"),
    path('comprobar/foto/', views.comprobar_usuario_foto, name="comprobar_usuario_foto"),
